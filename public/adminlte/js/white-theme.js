var whiteTheme = {
    ...
    // main icons
    'menu.normalIcon.path': '{!! json_encode(url('/adminlte/js/img/')) !!}img/icon-d.svg',
    ...
    // submenu icons
    'submenu.normalIcon.path': '{!! json_encode(url('/adminlte/js/img/')) !!}img/icon-d.svg',
    'submenu.normalIcon.name': 'icon-d',
    'submenu.activeIcon.path': '{!! json_encode(url('/adminlte/js/img/')) !!}img/icon-b.svg',
