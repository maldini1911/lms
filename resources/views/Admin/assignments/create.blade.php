...
@section('title-page') <i class="fas fa-plus"></i>  Create New Assignments @endsection
        ...
        <div class="container-fluid">
            <div class="card-body">
                ...
                <div class="questions">
                        <div class="row">
                            <div class="col-lg-12">
                                <form action="{{url('doctors/assignments/store')}}" method="POST" enctype="multipart/form-data">
                                    {{ csrf_field() }}
                                    <div class="row">
                                        <div class="col-lg-6" >
                                            <div class="quize-bar" style="background:#eee;padding:20px;border-radius:4px">
                                                ...
                                                <div class="form-group bmd-form-group">
                                                    @php $input = "name_assignment"; @endphp
                                                    <label class="bmd-label-floating" style="color:#111">Assignment Name </label>
                                                    <input type="text" class="form-control @error($input) is-invalid @enderror" name="{{$input}}" value="{{isset($row) ? $row->{$input}:''}}" required="required">
                                                    @error($input)
                                                        <span class="invalid-feedback" role="alert">
                                                            <strong>{{ $message }}</strong>
                                            ...
                                            <div class="fixed-data" style="background:#eee;padding:20px;border-radius:4px">
                                              ...
                                              <div class="form-group">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" name="fullmark">
                                                </div>
                                     ...
                                     <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <div class="section-edit-image">
                                                <div class="form-group mark-time">
                                                        <label for="exampleFormControlInput1">Mark</label></label>
                                                        <input type="text" class="form-control" name="mark_edit_image" style="width:200px" placeholder="Mark">
                                                </div>
                                            </div>
                                            <!-- End -->
                                        </div>
