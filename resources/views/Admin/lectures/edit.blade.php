...
<div class="col-lg-12" style="border-bottom:2px solid #eee;margin:20px 0">
    ...
    <div class="row">
        ...
        <div class="col-lg-3" style="margin:40px 0">
            ...
            <form action="{{url('doctors/lectures/url/edit/'.$url->id)}}" method="POST">
                {{csrf_field()}}
                ...
                <div style="background:#eee;padding:10px" class="text-center">
                    ...
                    <a href="{{url('doctors/lectures/url/delete/'.$url->id)}}" class="btn btn-danger"> Delete</a>
                </div>
            </form>
...
<div class="col-lg-12" style="border-bottom:2px solid #eee;margin:20px 0">
    ...
    <div class="row">
        ...
        <div class="col-lg-3" style="margin:40px 0">
            ...
            <form action="{{url('doctors/lectures/video/edit/'.$video->id)}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <input type="file" name="video" class="form-control" required="required">
                <div style="background:#eee;padding:10px" class="text-center">
                    <button tpye="submit" class="btn btn-success">Edit</button>
                    <a href="{{url('doctors/lectures/video/delete/'.$video->id)}}" class="btn btn-danger"> Delete</a>
                </div>
            </form>
...
<div class="col-lg-12" style="border-bottom:2px solid #eee;margin:20px 0">
    ...
    <div class="row">
        ...
        <div class="col-lg-3" style="margin:40px 0">
            ...
            <form action="{{url('doctors/lectures/image/edit/'.$image->id)}}" method="POST" enctype="multipart/form-data">
                {{csrf_field()}}
                <input type="file" name="image" class="form-control" required="required">
                 <div style="background:#eee;padding:10px" class="text-center">
                    <button tpye="submit" class="btn btn-success">Edit</button>
                    <a href="{{url('doctors/lectures/image/delete/'.$image->id)}}" class="btn btn-danger"> Delete</a>
                </div>
            </form>
