...
@section('title-page') <i class="fas fa-users"></i>  Quize  @endsection

@section('content')

<!-- Start Asignment -->
<div class="quize-edit">
    <h4 class="alert alert-info">Edit Quize </h4>
    <div class="row">
        <div class="col-lg-12">
            <form action="{{url('doctors/quizes/update/'.$row->id)}}" method="POST">
                {{csrf_field()}}
                <div class="row">
                    <div class="col-lg-6" >
                    ...
                    <div class="col-lg-6">
                        <div class="fixed-data" style="background:#eee;padding:20px;border-radius:4px">
                                ...
                                <label for="exampleInputEmail1" style="color:#111">Quize Scheduling </label>
                        ...
                        @if($question->type == 'text')
                            <div class="col-md-12">
                                <div class="card">
                                        ...
                                        <!-- /.card-header -->
                                        <div class="card-body">
                                            <form action="{{url('doctors/quizes/question/update/'.$question->id)}}" method="POST">
                                                {{csrf_field()}}
                                                <div class="form-group">
            ...
            @if($questions->where('type', 'choise_text')->isNotEmpty() OR $questions->where('type', 'choise_image')->isNotEmpty())
                @foreach($questions as $question)
                    ...
                    @if($question->type == 'choise_image')
                        <div class="card">
                            <div class="card-body">
                            <form action="{{url('doctors/quizes/question/update/'.$question->id)}}" method="POST" enctype="multipart/form-data">
                                {{csrf_field()}}
                                <div>
                                    <div class="row">
                                        <div class="col-lg-8">
                                        ...
                                        <div class="col-lg-5">
                                                ...
                                                <label for="exampleFormControlInput1">(1)</label>
                                                <hr>
                                                    <img src="{{url('/')}}/uploads/questions/quizes/{{$question->choise1}}" width="50%" height="200px">
                                                <hr>
                                        ...
                                        <div class="col-lg-5">
                                                ...
                                                <label for="exampleFormControlInput1">(2)</label>
                                                <hr>
                                                    <img src="{{url('/')}}/uploads/questions/quizes/{{$question->choise2}}"width="50%" height="200px">
                                                <hr>
                                        ...
                                        <div class="col-lg-5">
                                                ...
                                                <label for="exampleFormControlInput1">(3)</label>
                                                <hr>
                                                    <img src="{{url('/')}}/uploads/questions/quizes/{{$question->choise3}}" width="50%" height="200px">
                                                <hr>
                                        ...
                                        <div class="col-lg-5">
                                                ...
                                                <label for="exampleFormControlInput1">(4)</label>
                                                <hr>
                                                    <img src="{{url('/')}}/uploads/questions/quizes/{{$question->choise4}}" width="50%" height="200px">
                                                <hr>
