...
@section('title-page') <i class="fas fa-books"></i>  Projects @endsection
                  ...
                  <td>
                      <ul class="list-inline">
                          <li class="list-inline-item">
                              <img alt="Avatar" class="table-avatar" src="{{url('/')}}/adminlte/img/avatar.png">
                          </li>
                          <li class="list-inline-item">
                              <img alt="Avatar" class="table-avatar" src="{{url('/')}}/adminlte/img/avatar2.png">
                          </li>
                          <li class="list-inline-item">
                              <img alt="Avatar" class="table-avatar" src="{{url('/')}}/adminlte/img/avatar3.png">
                          </li>
                          <li class="list-inline-item">
                              <img alt="Avatar" class="table-avatar" src="{{url('/')}}/adminlte/img/avatar04.png">
                          </li>
                      </ul>
                  </td>
              ...
              <tr>
                  ...
                  <td>
                      <ul class="list-inline">
                          ...
                          <li class="list-inline-item">
                              <img alt="Avatar" class="table-avatar" src="{{url('/')}}/adminlte/img/avatar5.png">
                          </li>
                      </ul>
                  </td>
                  <td class="project_progress">
